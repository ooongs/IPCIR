...
def main():
    ...
    # Model paths
    parser.add_argument('--sdxl_path', default='/data/jinzhenxiong/temp/stabilityai/sdxl-turbo', type=str)
...
def run(args):
    ...
    # Load SDXL model
    print(f"Loading SDXL model from {args.sdxl_path}...")
    pipe = load_model(args.sdxl_path, device=device)
