...
class args_define():
    ...
    parser.add_argument('--test_multiple_scales', action='store_true',
                        help='Test multiple scale values from 0.0 to 1.0 with 0.1 step')
    parser.add_argument('--scale_start', type=float, default=0.0,
                        help='Start value for scale range (default: 0.0)')
    parser.add_argument('--scale_end', type=float, default=1.0,
                        help='End value for scale range (default: 1.0)')
    parser.add_argument('--scale_step', type=float, default=0.1,
                        help='Step size for scale range (default: 0.1)')
